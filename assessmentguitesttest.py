...
age = easygui.integerbox("Hello " + name + " how old are you?: ")
if age <= 7:
...
questionnum, score, done, questionsprint, questionAnswers, answer, answers = 0, 0, 0, "", "", 0, "a" + "b" + "c"
def questionsask():
    ...
    if questionnum == 0:
        questionsprint, questionAnswers, answer = info[15], info[0] + info[1] + info[2], info[21]
    elif questionnum == 1:
        questionsprint, questionAnswers, answer = info[16], info[3] + info[4] + info[5], info[22]
    elif questionnum == 2:
        questionsprint, questionAnswers, answer = info[17], info[6] + info[7] + info[8], info[20]
    elif questionnum == 3:
        questionsprint, questionAnswers, answer = info[18], info[9] + info[10] + info[11], info[22]
    elif questionnum == 4:
        questionsprint, questionAnswers, answer = info[19], info[12] + info[13] + info[14], info[20]
    elif questionnum == 5:
        return
    def askquestion():
        global score, questionrightcount, questionwrongcount, questionnum, questions, question5Answers, question4Answers, question3Answers, question2Answers, question1Answers, answers, questionsprint, questionAnswers, answer, done
